...
- (id)initWithFrame:(CGRect)frame photoUrls:(NSArray *)urls{
    ...
    if (self) {
        ...
        float zDistance = 2 * frame.size.width/2 * tanf(VIEW_ANGLE);
        for (int i = 0; i < self.photoArray.count; i+=2) {
            ...
            CATransform3D lTransform3D_3 = CATransform3DMakeTranslation(-200, 0, -400);
            ...
            CATransform3D rTransform3D_3 = CATransform3DMakeTranslation(-200, 0, -400);
