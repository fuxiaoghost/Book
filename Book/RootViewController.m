...
- (void)viewDidLoad
{
    ...
    PaperView *paperView = [[PaperView alloc] initWithFrame:CGRectMake(40, 0, SCREEN_HEIGHT-80, SCREEN_WIDTH) photoUrls:[NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"photos" ofType:@"plist"]]];
